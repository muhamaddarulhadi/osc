    ...
    <section
        ...
        <div class="row no-gutters text-center d-xl-flex justify-content-center align-items-center align-content-center justify-content-xl-center" style="margin-top: 46px;width: auto;">
            <div class="col d-xl-flex justify-content-xl-center">
                <div style="width: auto;"><a class="btn btn-primary" role="button" style="margin-bottom: 5px;" href="index.html">Log Keluar&nbsp;<i class="icon-logout" style="margin-left: 9px;"></i></a><a class="btn btn-primary" role="button" style="margin-left: 37px;margin-bottom: 5px;"
                        href="staff%20menu.html">Menu<i class="icon-menu" style="height: auto;margin-left: 9px;font-size: 16px;"></i></a></div>
            </div>
        </div>
        </section>
