<?php
    if(isset($_GET['email']) && $_GET['email'] !== '')
    {
        ...
        {
            $staf = mysqli_query($con,"SELECT email, fullname FROM tnc WHERE email = $email") or die ("Failed to query database" .mysql_error());
...
<body>
    ...
    <section>
        <div class="text-center profile-card" style="margin: 15px;background-color: #ffffff;padding-bottom: 15px;padding-top: 15px;">
            <div>
                ...
                <p style="padding:20px;padding-bottom:0;padding-top:5px;"><a href="mailto:robiha@unimap.edu.my"></a><?php echo $row['email'] ?><br></p>
            </div>
        </div>
    </section>
    <section class="text-center" style="width: auto;">
        <div style="width: auto;"><a class="btn btn-primary" role="button" style="margin-left: 37px;" href="index.html">Log Keluar&nbsp;<i class="icon-logout" style="margin-left: 9px;"></i></a><a class="btn btn-primary" role="button" style="margin-left: 37px;" href="Bantuan%20staff.html">Sunting Maklumat Anda&nbsp;<i class="icon ion-android-settings" style="margin-left: 9px;"></i></a>
            <a
                class="btn btn-primary" role="button" style="margin-left: 37px;" href="Bantuan%20tnc.html">Bantuan<i class="icon ion-help" style="margin-left: 9px;"></i></a>
        </div>
    </section>
    <section>
        <div class="text-center profile-card" style="margin: 15px;background-color: #ffffff;padding-bottom: 15px;padding-top: 15px;">
    ...
    <section>
        <div class="text-center profile-card" style="margin: 15px;background-color: #ffffff;padding-bottom: 15px;padding-top: 15px;">
            <div>
                <p style="padding:20px;padding-bottom:0;padding-top:5px;">Senarai pemohonan yang perlu di ambil kira oleh staf/pihak berwajib dan staf OSC</p>
            </div>
            <div></div>
        </div>
