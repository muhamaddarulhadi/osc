...
<body style="background-color: rgb(241,241,241);">
    ...
    <div
        ...
        <p class="profile-name-card" style="color: #000000;font-size: 30px;margin-bottom: 21px;margin-top: -17px;">Daftar</p>
        <form autocomplete="off" method="POST" action="/osc/php/register.php" class="form-signin"><span class="reauth-email"> </span><input class="form-control" name="email" type="email" id="inputEmail" required="" placeholder="E-Mel" autofocus="" autocomplete="off" style="font-size: 14px;line-height: 18px;"><input class="form-control" name="fullname" type="string" id="inputFullname"
                required="" placeholder="Nama Penuh" style="margin-top: 18px;font-size: 14px;line-height: 18px;" autocomplete="off" autofocus=""><input class="form-control" name="staffid" type="string" id="inputStaffID" required="" placeholder="Staf ID" style="margin-top: 18px;font-size: 14px;line-height: 18px;"
            ...
            <div class="form-row" style="margin-top: 29px;">
                <div class="col"><button class="btn btn-primary btn-block btn-lg btn-signin" type="reset" style="background-color: rgb(0,123,255);font-size: 14px;border-radius: 10px;">Kosongkan</button></div>
                <div class="col"><button class="btn btn-primary btn-block btn-lg btn-signin" value="Daftar" type="submit" style="background-color: rgb(0,123,255);font-size: 14px;border-radius: 10px;">Daftar</button></div>
            </div>
        </form>
        <div class="row no-gutters text-center" style="margin-top: 11px;">
